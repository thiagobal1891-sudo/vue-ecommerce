...
export default {
  ...
  data() {
    return {
      ...
      cartStore: useCartStore(), // ⬅️ Importa y usa el store
    }
  },
  computed: {
    orders() {
      // Aquí usamos el precio global del carrito: cartStore.precio
      return [
        { id: 874522648, date: "September 5, 2020", price: `$${this.cartStore.precio}`, status: "Paid" },
        { id: 874522649, date: "September 7, 2020", price: `$${this.cartStore.precio}`, status: "Paid" },
        { id: 874522650, date: "September 9, 2020", price: `$${this.cartStore.precio}`, status: "Processing" },
        { id: 874522651, date: "September 12, 2020", price: `$${this.cartStore.precio}`, status: "Cancelled" },
      ]
    },
    filteredOrders() {
