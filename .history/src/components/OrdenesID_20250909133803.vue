...
import { useCartStore } from '@/stores/cart' // ajusta la ruta si es necesario
...
const orders = computed(() => {
  return cartStore.cart.map(producto => ({
    id: producto.id,
    date: 'September 5, 2020',  // fijo
    price: producto.price,
    status: 'Paid'              // fijo (puedes agregar lógica para otros estados)
  }))
})
...
const filteredOrders = computed(() => {
  return orders.value.filter(order => {
    ...
    // filtro por búsqueda (id o date o price)
