...
<tbody v-if="productos.cart.length">
  <tr :key="productos.cart[productos.cart.length - 1].id">
    <!-- Columna Product Name -->
    <td>
      <img :src="productos.cart[productos.cart.length - 1].image" alt="" style="width:60px; height:60px; border-radius:8px; margin-right:10px;">
      <div>
