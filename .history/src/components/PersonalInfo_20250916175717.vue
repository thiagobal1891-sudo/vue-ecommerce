<template>
  ...
  <div class="containeido_personal">
  ...
  <div class="campo">
    ...
    <input type="text" placeholder="">
            ...
            <input class="number" placeholder="+598 ">
...
@media (max-width: 600px) {
  .fila {
    flex-direction: column; /* en mobile se apilan */
    gap: 20px;              /* reducimos el espacio */
  }
  ...
  .contraseña,
  .date {
    width: 100%;  /* cada input ocupa todo el ancho disponible */
    max-width: 100%;
  }

  .info-header,
  .perfil {
    width: 100%;  /* que no queden fijos en 874px */
  }

  h3 {
    width: 100%; /* igual que arriba */
  }
}
